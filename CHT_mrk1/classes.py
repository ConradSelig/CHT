...
class HashMapValue:
    """
    The CHT_mrk1 is built out of instances of this class. Hash requests should never be made to this class and should always
    be made through the CHT_mrk1 holding this classes objects.
    """
